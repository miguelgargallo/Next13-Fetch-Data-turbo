...
var Footer = () => {
  return /* @__PURE__ */ (0, import_jsx_runtime21.jsxs)("footer", {
    className: "bg-white py-8 text-center",
    children: [
      /* @__PURE__ */ (0, import_jsx_runtime21.jsx)("div", {
        children: /* @__PURE__ */ (0, import_jsx_runtime21.jsxs)("a", {
          children: [
            "Made with \u2764\uFE0F by",
            " ",
...
var Scrollable = () => {
  const { scrollYProgress } = useScroll();
  return /* @__PURE__ */ (0, import_jsx_runtime22.jsx)(motion.div, {
    className: "progress-bar",
    style: { scaleX: scrollYProgress }
  });
};
