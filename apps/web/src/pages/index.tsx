  ...
  return (
    <div className="min-w-screen flex min-h-screen flex-col bg-white">
      ...
      <main className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="mx-auto max-w-7xl rounded-lg py-2 py-2 px-4 text-center sm:p-2">
          <h1 className="text-3xl font-bold leading-tight text-gray-900">
            ...
            >
              ...
              <a>
                ...
                <picture>
                  <img
                    darksrc="https://raw.githubusercontent.com/miguelgargallo/tlds-leveling/main/images/handshake-logo-dark.svg"
              ...
              <p className="py-2 text-sm text-gray-500">
                Block Explorer and Naming Tool for Handshake, the decentralized,
                open, and extensible naming system for the Internet.
              </p>
            </a>
            <a
              href="https://twitter.com/pencildomains"
            ...
            <div className="m-8 rounded-xl px-2 py-2 text-sm font-light shadow-md hover:shadow-xl">
              ...
              <a>
                ...
                redesigned the UI and make able to categorize and filter the
                domain extension by levels.
              </a>
            </div>
          </h1>
