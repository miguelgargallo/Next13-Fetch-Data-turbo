        ...
        <div className="d-md-flex flex-md-equal w-100 my-md-3 pl-md-3">
          <div className="bg-light mr-md-3 pt-md-5 px-md-5 overflow-hidden px-3 pt-3 text-left">
            ...
            <p>
              ...
              <a href="https://tools.ietf.org/html/rfc5731" target="_blank" rel="noreferrer">
                EPP
              </a>
            ...
            <p>
              ...
              <a href="https://developer.pencil.domains" target="_blank" rel="noreferrer">
                Pencil Developer
              </a>
              and Contact Twitter.
            </p>
            ...
            <p>
              ...
              <a href="https://fastest.pencil.domains" target="_blank" rel="noreferrer">
            ...
            <p>
              ...
              <a href="https://pencil.domains/tos" target="_blank" rel="noreferrer">
                pencil.domains terms of service here
              </a>
              and the
              <a href="https://pencil.domains/privacy" target="_blank" rel="noreferrer">
            ...
            <p>
              ...
              You can see read the
              <a href="https://developer.pencil.domains/tos" target="_blank" rel="noreferrer">
                pencil.domains terms of service here
              </a>
              and the
              <a href="https://pencil.domains/privacy" target="_blank" rel="noreferrer">
            ...
            <p>
              ...
              store a cookie there so you do not have to enter the code each time
              you log in. If you would rather enter the code each time, simply make
