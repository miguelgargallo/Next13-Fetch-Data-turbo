        ...
        <div className="d-md-flex flex-md-equal w-100 my-md-3 pl-md-3">
          <div className="bg-light mr-md-3 pt-md-5 px-md-5 overflow-hidden px-3 pt-3 text-left">
            ...
            <p>
              ...
              <a href="https://nextdns.io" target="_blank">
                NextDNS
              </a>{" "}
              or{" "}
              <a
            ...
            <p>
              {" "}
              <a href="https://tools.ietf.org/html/rfc5731" target="_blank">
                EPP
              </a>{" "}
            ...
            <p>
              ...
              <a href="https://developer.pencil.domains" target="_blank">
                Pencil Developer
              </a>
              and Contact Twitter.
            </p>
            ...
            <p>
              ...
              <a href="https://fastest.pencil.domains" target="_blank">
            ...
            <p>
              ...
              <a href="https://pencil.domains/tos" target="_blank">
                pencil.domains terms of service here
              </a>{" "}
              and the{" "}
              <a href="https://pencil.domains/privacy" target="_blank">
            ...
            <p>
              {" "}
              You can see read the{" "}
              <a href="https://developer.pencil.domains/tos" target="_blank">
                pencil.domains terms of service here
              </a>{" "}
              and the{" "}
              <a href="https://pencil.domains/privacy" target="_blank">
            ...
            <p>
              {" "}
              <strong>
                I don't think GA or DUO worked because I wasn't asked for it
                when logging in.
              </strong>
            </p>
            <p>
              ...
              store a cookie there so you don't have to enter the code each time
              you log in. If you'd rather enter the code each time, simply make
              sure to log out of pencil.domains and the cookie will be deleted.
            </p>
            <p>
              {" "}
